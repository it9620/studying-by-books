...
class TestConnection(unittest.TestCase):
    ...
    def test_exchange_with_server(self):
        with unittest.mock.patch(
            ...
            c1.broadcast("connection message")
            assert c2.get_messages()[-1] == "connection message"
...
class FakeServer:
    ...
    def send(self, data):
        # Trak any command that was sent to the server
