...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		NEWLINE=11, WS=12;
	public static final int
		RULE_prog = 0, RULE_stat = 1, RULE_expr = 2, RULE_clear = 3;
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ClearingContext extends StatContext {
		public ClearContext clear() {
			return getRuleContext(ClearContext.class,0);
		}
		public TerminalNode NEWLINE() { return getToken(LabeledExprParser.NEWLINE, 0); }
		public ClearingContext(StatContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitClearing(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				break;
			case 4:
				_localctx = new ClearingContext(_localctx);
	...
	public final ClearContext clear() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_clear);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(47);
